...
<img style='float: center' src='/home/elouen/Documents/GreenSloth/models/Matuszynska2016/paper_figures/Matuszynska_fig4.svg'>
...
<img style='display: block; margin: 0 auto' src='/home/elouen/Documents/GreenSloth/models/Matuszynska2016/paper_figures/Matuszynska_fig5.svg'>
                     
#### Figure 5

Visualisation of lumenal pH ($${pH_lu}$$), protonated PsbP ($${PsbSP}$$), and Zeaxanthin ($${Zx}$$) of simulated pulse amplitude modulation (PAM) measurements of wild type *Arabidopsis thaliana* and a parameter phase projection of $${pH_lu}$$ and the quencher activity ($${Q}$$) under different light intensities. The simulated PAM protocol included three phases: an initial light exposure, relaxation in the dark and a second light exposure. Both light exposures were done with 100 $$\muEm^{-2}s^{-1}$$, 300 $$\muEm^{-2}s^{-1}$$, and 900 $$\muEm^{-2}s^{-1}$$ and the duration of the phases were $$14 min$$, $$16 min$$, and $$5 min$$ respectively. In the parameter phase projection, the red line indicates steady-state simulation results under light intensities from zero to 1000 in steps of 10, where each big red circle indicates one fo the prior listed light intensities.
