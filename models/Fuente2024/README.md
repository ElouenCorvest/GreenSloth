...
<img style='float: center' src='figures/fuente2024_fig2.svg' alt='Figure 2' width='600'/>
...
<img style='float: center' src='figures/fuente2024_fig3.svg' alt='Figure 3' width='600'/>
...
<img style='float: center' src='figures/fuente2024_fig4.svg' alt='Figure 4' width='600'/>
...
| Flux                          | In Model          |
| -----------                   | -----------       |
| $\mathrm{PSII}$             | v_\mathrm{PSII \vert PQ} |
...
\mathrm{NPQ_{max}} and k_4 are the parameters fitted.
